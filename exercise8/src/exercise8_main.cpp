...
int main() {
    cout << "Exercise 8: Classes with separate compilation" << endl;
    cout << "\nTask 1: Book" << endl;
    cout << "---" << endl;
    ...
    vector<Song> chart;
    ifstream fileIn;
    fileIn.open("data/exercise8_top3.txt");
    if (fileIn.fail()) {
        cerr << "ERROR: Could not open data/exercise8_top3.txt" << endl;
        exit(1);
    }
    while (!fileIn.eof()) {
        string artist, title;
    ...
    cout << "Expected: Content of the data/exercise8_top3.txt" << endl;
    cout << "Observed: " << endl;
    ...
    cout << "\nTask 10: Roster" << endl;
    cout << "---" << endl;
    Roster *r10 = new Roster("data/exercise8_roster.txt");
    cout << "Expected: " << "Alice (3.00) majors in Anthropology" << endl;
    cout << "Observed: " << r10->getStudentList().at(0) << endl;
    cout << "---" << endl;
    cout << "Expected: Roster based on the content of the data/exercise8_roster.txt" << endl;
    cout << "Observed: " << *r10;
    cout << "---" << endl;
