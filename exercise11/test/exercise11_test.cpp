...
TEST_CASE("Add N", "[addN]") {
  ...
  CHECK(addN<string>("Hello ", "students", " ", "of ", "CS253") ==
        "Hello students of CS253");
  CHECK(addN(10000000000, 20000000000, 30000000000, 40000000000) ==
        100000000000);
}
...
TEST_CASE("Average N", "[avgN]") {
  ...
  CHECK(avgN(30000000000, 30000000000, 40000000000) ==
        Approx(33333333333.3).margin(0.01));
